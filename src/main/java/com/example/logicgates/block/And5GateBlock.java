...
/** 5-input AND gate: output is 15 only when ALL 5 inputs are active (> 0). */
public class And5GateBlock extends MultiInputGateBlock {

    public static final MapCodec<And5GateBlock> CODEC = simpleCodec(And5GateBlock::new);

    public And5GateBlock(BlockBehaviour.Properties props) {
        super(props);
    }

    @Override
    public MapCodec<And5GateBlock> codec() {
        return CODEC;
    }
